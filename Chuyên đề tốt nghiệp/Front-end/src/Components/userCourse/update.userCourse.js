...
class UpdateUserCourse extends Component {
    ...
    render() {
        return (
            <Mutation mutation={EDIT_USERCOURSE}>
                {(editUserCourse) => (
                    <div style={{ display: 'inline-block' }}>
                        ...
                        <Modal
                            title="Update UserCourse"
                            visible={this.state.visible}
                            onOk={() => this.handleOk(editUserCourse)}
...
export default Form.create({ name: 'formUpdateUSER' })(UpdateUserCourse)